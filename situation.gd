...
static var ALL_SITUATIONS: Array[Situation] = [
	...
	Situation.new("Patrol of small enemies. You don't want to escape.",[[Traits.ETraits.high_rate_of_fire], [Traits.ETraits.area_low_damage], [Traits.ETraits.explosive_large], [Traits.ETraits.explosive_multiple], [Traits.ETraits.paralyze], [Traits.ETraits.shield]]),
	Situation.new("Patrol of small enemies. You are under time pressure.",[[Traits.ETraits.high_rate_of_fire, Traits.ETraits.turret], [Traits.ETraits.area_low_damage], [Traits.ETraits.explosive_large], [Traits.ETraits.explosive_multiple], [Traits.ETraits.paralyze], [Traits.ETraits.blocks_sight], [Traits.ETraits.escape], [Traits.ETraits.shield]]),
	Situation.new("Bile Titan", [[Traits.ETraits.explosive_large], [Traits.ETraits.high_damage]]),
	Situation.new("Out of ammo", [[Traits.ETraits.supply]]),
]
